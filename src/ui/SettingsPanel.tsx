...
import { SharingManagementPanel } from "./SharingManagementPanel";
...
export const SettingsPanel = React.memo(function SettingsPanel({
  ...
  return (
    <>
      ...
      <SharingManagementPanel isOpen={sharingPanelOpen} onClose={() => setSharingPanelOpen(false)} />
    </>
  );
});
